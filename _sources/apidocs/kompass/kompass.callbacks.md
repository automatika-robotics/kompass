...
* - {py:obj}`PoseStampedCallback <kompass.callbacks.PoseStampedCallback>`
  - ```{autodoc2-docstring} kompass.callbacks.PoseStampedCallback
    :summary:
    ```
* - {py:obj}`DetectionsCallback <kompass.callbacks.DetectionsCallback>`
  - ```{autodoc2-docstring} kompass.callbacks.DetectionsCallback
    :summary:
    ```
* - {py:obj}`TrackingsCallback <kompass.callbacks.TrackingsCallback>`
  - ```{autodoc2-docstring} kompass.callbacks.TrackingsCallback
    :summary:
    ```
...
`````{py:class} DetectionsCallback(input_topic, node_name: typing.Optional[str] = None, buffer_size: int = 1)
:canonical: kompass.callbacks.DetectionsCallback
...
````{py:method} set_buffer_size(value: int, clear_old: bool = False) -> None
:canonical: kompass.callbacks.DetectionsCallback.set_buffer_size

```{autodoc2-docstring} kompass.callbacks.DetectionsCallback.set_buffer_size
```

````

````{py:method} callback(msg) -> None
:canonical: kompass.callbacks.DetectionsCallback.callback

```{autodoc2-docstring} kompass.callbacks.DetectionsCallback.callback
```

````

````{py:property} depth_image
:canonical: kompass.callbacks.DetectionsCallback.depth_image
:type: typing.Optional[numpy.ndarray]

```{autodoc2-docstring} kompass.callbacks.DetectionsCallback.depth_image
```
...
`````{py:class} TrackingsCallback(input_topic, node_name: typing.Optional[str] = None, buffer_size: int = 10)
:canonical: kompass.callbacks.TrackingsCallback
...
````{py:method} callback(msg) -> None
:canonical: kompass.callbacks.TrackingsCallback.callback

```{autodoc2-docstring} kompass.callbacks.TrackingsCallback.callback
```

````

````{py:method} set_buffer_size(value: int, clear_old: bool = False) -> None
:canonical: kompass.callbacks.TrackingsCallback.set_buffer_size

```{autodoc2-docstring} kompass.callbacks.TrackingsCallback.set_buffer_size
```

````

````{py:method} set_target(label: str, idx: typing.Optional[int] = None)
:canonical: kompass.callbacks.TrackingsCallback.set_target

```{autodoc2-docstring} kompass.callbacks.TrackingsCallback.set_target
```
