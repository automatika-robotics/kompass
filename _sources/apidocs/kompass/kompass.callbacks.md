...
`````{py:class} DetectionsCallback(input_topic, node_name: typing.Optional[str] = None, buffer_size: typing.Optional[int] = 10)
...
:canonical: kompass.callbacks.DetectionsCallback.set_target

```{autodoc2-docstring} kompass.callbacks.DetectionsCallback.set_target
```
...
`````{py:class} TrackingsCallback(input_topic, node_name: typing.Optional[str] = None, buffer_size: typing.Optional[int] = 10)
:canonical: kompass.callbacks.TrackingsCallback

Bases: {py:obj}`kompass.callbacks.DetectionsCallback`
