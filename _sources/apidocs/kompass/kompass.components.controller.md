...
:canonical: kompass.components.controller.Controller.create_all_action_servers

```{autodoc2-docstring} kompass.components.controller.Controller.create_all_action_servers
```
...
````{py:method} set_algorithm(algorithm_value: typing.Union[str, kompass_core.control.ControllersID]) -> bool
